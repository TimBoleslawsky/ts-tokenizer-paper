...
\usepackage{subfig}	
\usepackage{booktabs}
\usepackage{multirow}								% Enables subfigures
...
\usepackage[skip=10pt]{parskip}								% Enables vertical spaces correctly 
...
% Avoid large vertical stretch between blocks when float-heavy pages are balanced.
\raggedbottom
